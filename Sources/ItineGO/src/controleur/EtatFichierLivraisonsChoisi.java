...
public class EtatFichierLivraisonsChoisi extends EtatDefaut {
	...
	/**
	 * Permet de valider le fichier pris en compte et de passer à la vue suivante où les livraisons sont affichées.
	 * Si le fichier n'est pas bon on reste en l'état, sinon on passe a l'état EtatLivraisonsAffichees.
	 * 
	...
	/**
	 * Permet de faire un glisser deposer d'un fichier, si le fichier est accepté on reste en l'état sinon on revient à l'état EtatPlanVilleAffiche. 
	...
	/**
	 * Permet de choisir un fichier, si le fichier est accepté on reste en l'état sinon on revient à l'état EtatPlanVilleAffiche. 
	 * On va indiquer à la vue si le fichier est accepté ou non et celle-ci affichera un message correspondant.
	 * 
	 * @param controleur : Controleur de l'application.
	 * @param accepte : Indique si le fichier a été accepté ou non.
	...
	/**
	 * Efface tous les noeuds et tronçons du plan chargé puis retourne à la vue choixPlanVilleVue.
	 * On met l'état courant à l'état EtatApplicationDemarree.
	 * 
	 * @param controleur : Controleur de l'application.
	 * @param gestionnaire : Gestionnaire de l'application.
	 */
